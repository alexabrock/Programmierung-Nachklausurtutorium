...
\title{\abschluss{}\\Tag 1: Datentypen, Bedingungen und Arrays}                      % HIER DEN TITEL DER ARBEIT EINTRAGEN
\author{Sven Hoops, Jonas Goudarzi}
% HIER DEN NAMEN UND VORNAMEN EINTRAGEN
\date{10.03.2025}                                                                % HIER DAS PRÄSENTATIONSDATUM EINTRAGEN
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
