...
\begin{frame}{Link zum Repository}  
    \begin{itemize}
      \item \textbf{GitHub für dieses Tutorium} (hier findet ihr auch diese Präsentation): \url{https://github.com/alexabrock/Programmierung-Nachklausurtutorium}
    \end{itemize}
    \includegraphics[height=0.5\textheight]{images/qrcode.png}
\end{frame}
...
\begin{frame}{Reflexion von Fehlern}
\begin{exampleblock}{Hinweise für die Fehleranalyse}
  \begin{itemize}
    \item Schaut euch eure korrigierte 1. Klausur/ Probeklausur noch einmal genau an.
    \item Fragt euch: „Warum habe ich diese Aufgabe nicht richtig gelöst?“
    \item Überlegt euch, was schiefgelaufen ist und wie ihr es beim nächsten Mal vermeiden könnt.
    \item Wer die Fehler versteht, lernt am meisten.
  \end{itemize}
\end{exampleblock}
\end{frame}
