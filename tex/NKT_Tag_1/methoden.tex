...
\end{lstlisting}
\begin{itemize}
    \item 1. Sichtbarkeit: Ohne keyword package-private. Standard der Vorlesung
    \item 2. Kontext
    \item 3. Rückgabetyp
    \item 4. Name
    \item 5. Parameter
...
\begin{lstlisting}
    static int isGreater(int a, int b){
        if(a > b){
...
Die Main Methode hat als Parameter ein \textit{String} Array. Der Inhalt des Arrays muss beim Aufruf des Programmes mit übergeben werden.
\begin{lstlisting}
