...
\newcommand{\abschluss}{NKT}                              % HIER UNZUTREFFENDES LÖSCHEN
\title{\abschluss{}\\Tag 3: Interfaces, Such/Sortieralgorithmen, Verkettete Listen}                      % HIER DEN TITEL DER ARBEIT EINTRAGEN
\author{Tobias Wrede, Alexa Katharina-Ronja Brockmöller}
